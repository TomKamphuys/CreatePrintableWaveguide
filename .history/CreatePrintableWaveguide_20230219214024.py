...
def generatePetalConnection(petal: adsk.fusion.BRepBody, petalConnectionSettings: PetalConnector):
    ...
    # extInput.setSymmetricExtent(connectionHeight, isFullLength=True)

    extrudes.addSimple(prof6b, petalConnectionDepth, adsk.fusion.FeatureOperations.NewBodyFeatureOperation)
